...
<main>
        <section class="products">
            <div class="phonebox">
                <img src="samsunggalaxts20.jpg" alt="p1" class="phoneimg"><br>
                <span class="phonename"> Samsung Galaxy S20 </span> <br>
                <span class="phoneprice"> $500.00 </span> 

            </div>
            <div class="phonebox">
                <img src="samsunggalaxynot20.jpg" alt="p1" class="phoneimg"><br>
                <span class="phonename">Samsung Galaxy Note 2021</span> <br>
                <span class="phoneprice"> $500.00 </span> 
            </div>
            <div class="phonebox">
                <img src="Samsung Galaxy S21 5G.jpg" alt="p1" class="phoneimg"><br>
                <span class="phonename"> Samsung Galaxy Note 2020</span> <br>
                <span class="phoneprice"> $500.00 </span> 
            </div>
        </section>
        ...
        <section class="products">
            <div class="phonebox">
                <img src="Samsung Galaxy S21 Ultra 5G.jpg" alt="p1" class="phoneimg"><br>
                <span class="phonename"> Samsung Galaxy S21 Ultra 5G </span> <br>
                <span class="phoneprice"> $500.00 </span> 

            </div>
            <div class="phonebox">
                <img src="Samsung Galaxy S21+ 5G.jpg" alt="p1" class="phoneimg"><br>
                <span class="phonename">Samsung Galaxy S21+ 5G</span> <br>
                <span class="phoneprice"> $500.00 </span> 

            </div>
            <div class="phonebox">
                <img src="samsunggalaxts20.jpg" alt="p1" class="phoneimg"><br>
                <span class="phonename"> Samsung Galaxy </span> <br>
                <span class="phoneprice"> $500.00 </span>
            </div>
        </section>
        <br><br>
        <section class="checkoutbox">
            ...
            <form class = "checkoutform" method="POST" target="_self">
                ...
                <select name="product" id="product" required>
                    ...
                    <option value="Samsung Galaxy Note 2021">Samsung Galaxy Note 2021</option>
                    <option value="Samsung Galaxy Note 2020">Samsung Galaxy Note 2020</option>
